...
public class ExerciceTest {
    ...
    @Before
    public void setUp() {
        Exercice instance = new Exercice (new Reference ("script"));
    }
    ...
    public void testAddTry() {
        ...
        Try newTry = new Try (instance ,"script 1");
    ...
    public void testGetListTry() {
        ...
        Try try1= new Try (instance ,"script 1");
        Try try2= new Try (instance ,"script 2");
    ...
    public void testChangeReference() {
        ...
        Exercice instance = new Exercice (new Reference("coucou"));
